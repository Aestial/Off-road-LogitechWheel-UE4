...
const FKey ILogitechWheelPlugin::LogitechSW_WheelEnterButton("WheelEnterButton");
...
TSharedPtr<class IInputDevice> FLogitechWheelPlugin::CreateInputDevice(const TSharedRef<FGenericApplicationMessageHandler>& InMessageHandler)
{
	...
	EKeys::AddKey(FKeyDetails(ILogitechWheelPlugin::LogitechSW_WheelEnterButton, LOCTEXT("WheelEnterButton", "Logitech Wheel Enter Button"), FKeyDetails::GamepadKey));
